"""Legend HSSD-HAB input converter.

This module preserves the old HSSD/BM-instance conversion path for comparison
and regression work. It is intentionally under ``benchmark.legend`` because the
current product input is natural language, not pre-structured HSSD cases.
"""
