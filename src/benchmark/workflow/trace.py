...
def build_workflow_trace(state: dict, out_dir: str | Path | None = None) -> dict:
    ...
    nodes = [
        {"id": "normalize_input", "status": "success", "artifacts": {"case": artifact_path(state.get("case_path", ""), out_dir)}},
        {"id": "generate_layout", "status": "success", "artifacts": {"layout": artifact_path(state.get("current_layout_path", ""), out_dir)}},
        {
            "id": "evaluate_layout",
            "status": "success",
            "artifacts": {
