...
def visible_relations(case: dict) -> list[dict]:
    """Return only model-visible relation claims, preserving legacy behavior."""
...
def visible_attachments(case: dict) -> list[dict]:
    """Return only model-visible attachment claims, preserving legacy behavior."""
...
def find_layout_object(layout: dict, ref: str) -> dict | None:
    """Resolve an object reference by id first, then by category."""
