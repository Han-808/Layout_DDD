...
#   bash Support/bash/hyak/qwen3vl_server.sh submit
#   bash Support/bash/hyak/qwen3vl_server.sh status
#   bash Support/bash/hyak/qwen3vl_server.sh tail
#   bash Support/bash/hyak/qwen3vl_server.sh stop
#
...
usage() {
  cat <<EOF
Usage: bash Support/bash/hyak/qwen3vl_server.sh <submit|server|status|tail|stop|dry-run>
...
Examples:
  bash Support/bash/hyak/qwen3vl_server.sh submit
  MODEL_PROFILE=8b bash Support/bash/hyak/qwen3vl_server.sh submit
  MODEL_PROFILE=2b bash Support/bash/hyak/qwen3vl_server.sh submit
  MODEL_PROFILE=32b CONTEXT_LENGTH=65536 bash Support/bash/hyak/qwen3vl_server.sh submit
  JOB_IDS="36168488 36168454" bash Support/bash/hyak/qwen3vl_server.sh stop
  bash Support/bash/hyak/qwen3vl_server.sh stop
EOF
}
