...
JUDGE_CONFIG="${JUDGE_CONFIG:-$REPO_ROOT/configs/models/gpt5_6_sol_litellm_local_visual_config_judge.json}"
OUT_DIR="${OUT_DIR:-$REPO_ROOT/Support/artifacts/outputs/exp1_1_visual_config_gpt56}"
...
echo "Starting GPT-5.6-Sol VisualConfig replay over frozen exp1_1 evidence"
echo "Evidence: $EVIDENCE_ROOT"
echo "Output:   $OUT_DIR"
echo "Arms: 9 deterministic presentation/context/order/budget arms"
echo "Calls: 24 frozen events x 9 arms = 216"
echo "Workers: $MAX_WORKERS"
echo "Blender/rendering/camera selection/VLM choose-topK: disabled"
...
exec "$PYTHON_BIN" scripts/judge_cal_dataset1_visual_config.py \
