...
from benchmark.legend.pipeline import PipelineResources, load_pipeline_resources, run_case_pipeline
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=(
            "LEGEND: run the 10-scene HSSD-HAB validity sweep across four input representation modes "
