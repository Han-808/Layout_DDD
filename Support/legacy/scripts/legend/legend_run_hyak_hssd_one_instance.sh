...
#
# Usage:
#   bash Support/legacy/scripts/legend/legend_run_hyak_hssd_one_instance.sh <instance_index:0-9> <mode_flag:0|1>
#
# Mode flag:
#   0 = compact_objects
...
if [[ $# -ne 2 ]]; then
  echo "Usage: bash Support/legacy/scripts/legend/legend_run_hyak_hssd_one_instance.sh <instance_index:0-9> <mode_flag:0|1>" >&2
  exit 2
fi
...
cmd=(
  "${BENCH_PYTHON}" "${REPO_ROOT}/Support/legacy/scripts/legend/legend_run_hssd_hab_10_qwen_validity.py"
  --hssd-root "${HSSD_ROOT}" \
