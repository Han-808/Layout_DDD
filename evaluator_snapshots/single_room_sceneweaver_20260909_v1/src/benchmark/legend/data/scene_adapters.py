...
from benchmark.legend.data.local_assets import LOCAL_ASSET_SOURCE, resolve_local_asset_ref
from benchmark.legend.data.local_scenes import LOCAL_SCENE_SOURCE, load_local_scene, resolve_local_scene_ref
