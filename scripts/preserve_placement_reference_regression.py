"""Preserve C-R1 ownership-reference repair and complete scoring inputs.
...
def main():
    ...
    parser.add_argument('--case-id', default='S100')
    args = parser.parse_args()
    args.destination.mkdir(parents=True, exist_ok=False)
    case = args.evaluation/'judgement/cases'/args.case_id
    scene = args.evaluation/'dataset'/args.case_id/'scene/canonical_scene.json'
    ...
    fixture = {'schema_version':'placement_reference_repair_replay_v1',
        'case_id':args.case_id, 'trial_identity':'diagnostics/trial_01/attempt_01',
    ...
    path = args.destination/(args.case_id+'_diagnostics_R1.json')
